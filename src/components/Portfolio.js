					...
					<section id="cd-timeline" className="cd-container">
						...
						<div className="cd-timeline-block">
							...
							<div className="cd-timeline-content">
								<h2>{`Kylie.ai`}</h2>
								<div className="portfolio-img">
									<a href="https://www.kylie.ai" target="_blank"><img src="/imgs/kylie.png" role="presentation"/></a>
								</div>
						...
						<div className="cd-timeline-block">
							...
							<div className="cd-timeline-content">
								...
								<div className="portfolio-img">
									<a href="https://generalassemb.ly/education/web-development-immersive" target="_blank"><img src="/imgs/generalassembly.png" role="presentation"/></a>
								</div>
						...
						<div className="cd-timeline-block">
							...
							<div className="cd-timeline-content">
								<h2>impactWatch</h2>
								<div className="portfolio-img">
									<a href="https://impactwatch.herokuapp.com" target="_blank"><img src="/imgs/impactwatch.png" role="presentation"/></a>
								</div>
						...
						<div className="cd-timeline-block">
							...
							<div className="cd-timeline-content">
								<h2>Ede-Men</h2>
								<div className="portfolio-img">
									<a href="https://ede-men.herokuapp.com" target="_blank"><img src="/imgs/edemen.png" role="presentation"/></a>
								</div>
						...
						<div className="cd-timeline-block">
							...
							<div className="cd-timeline-content">
								<h2>Wander</h2>
								<div className="portfolio-img">
									<a href="https://wanderwithme.herokuapp.com" target="_blank"><img src="/imgs/wander.png" role="presentation"/></a>
								</div>
						...
						<div className="cd-timeline-block">
							...
							<div className="cd-timeline-content">
								<h2>Clarity</h2>
								<div className="portfolio-img">
									<a href="https://marketclarity.herokuapp.com" target="_blank"><img src="/imgs/clarity.png" role="presentation"/></a>
								</div>
						...
						<div className="cd-timeline-block">
							...
							<div className="cd-timeline-content">
								<h2>Foodify</h2>
								<div className="portfolio-img">
									<a href="https://foodifyme.herokuapp.com" target="_blank"><img src="/imgs/foodify.png" role="presentation"/></a>
								</div>
						...
						<div className="cd-timeline-block">
							...
							<div className="cd-timeline-content">
								<h2>Mastermind</h2>
								<div className="portfolio-img">
									<a href="https://williamnamen.com/mastermind" target="_blank"><img src="/imgs/mastermind.png" role="presentation"/></a>
								</div>
						...
						<div className="cd-timeline-block">
							...
							<div className="cd-timeline-content">
								...
								<div className="portfolio-img">
									<a href="https://www.fisherinvestments.com/" target="_blank"><img src="/imgs/fisher.png" role="presentation"/></a>
								</div>
						...
						<div className="cd-timeline-block">
							...
							<div className="cd-timeline-content">
								...
								<div className="portfolio-img">
									<a href="https://www.appacademy.io/bootcamp-prep/live" target="_blank"><img src="/imgs/appacademy.png" role="presentation"/></a>
								</div>
						...
						<div className="cd-timeline-block">
							...
							<div className="cd-timeline-content">
								...
								<div className="portfolio-img">
									<a href="https://www.codecademy.com/" target="_blank"><img src="/imgs/codeacademy.png" role="presentation"/></a>
								</div>
								<p></p>
						...
						<div className="cd-timeline-block">
							...
							<div className="cd-timeline-content">
								...
								<div className="portfolio-img">
									<a target="_blank"><img src="/imgs/sanfrancisco.jpg" role="presentation"/></a>
								</div>
								<p></p>
								<span className="cd-date">August 2015</span>
							</div>
						...
						<div className="cd-timeline-block">
							...
							<div className="cd-timeline-content">
								...
								<div className="portfolio-img">
									<a href="http://www.unf.edu/" target="_blank"><img src="/imgs/unf.jpg" role="presentation"/></a>
								</div>
